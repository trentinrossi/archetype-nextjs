...
// GET /api/credit-cards/account/:accountId/status/:cardStatus - Get credit cards by account and status
export async function GET(
  request: NextRequest,
  { params }: { params: { accountId: string; cardStatus: string } }
) {
  try {
    ...
    console.error('Error fetching credit cards by account and status:', error);
